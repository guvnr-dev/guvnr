...
1. **Friction Taxonomy** — 45 documented friction points across 13 categories
2. **Mitigation Strategies** — 30+ research-backed approaches to reduce friction
3. **Ready-to-Deploy Tools** — Slash commands, subagents, hooks, and automation
...
| Document | Purpose |
|----------|---------|
| [ai-development-friction.md](ai-development-friction.md) | 45 friction points from the AI's perspective |
| [ai-friction-mitigations.md](ai-friction-mitigations.md) | Research-backed mitigation strategies |
