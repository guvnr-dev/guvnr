  ...
  it("should have valid frontmatter in all commands", () => {
    for (const file of commandFiles) {
      ...
      assert.ok(
        ...
        `${file} description should be meaningful`,
      );
    }
  });
...
describe("Security Review Command", () => {
  ...
  it("should have verdict options", () => {
    assert.ok(
      content.includes("SECURE") || content.includes("✅"),
...
describe("Subagent Structure", () => {
  ...
  it("should specify tools in explorer agent", () => {
    const explorerContent = readFileSync(
      join(AGENTS_DIR, "explorer.md"),
      "utf-8",
    );
...
describe("Cross-Reference Validation", () => {
  ...
  it("should have matching descriptions in README", () => {
    ...
    assert.ok(
      readme.includes("/security-review"),
      "README should document /security-review",
    );
  });
});

console.log(
  "Command tests loaded. Run with: node --test tests/commands.test.js",
);
