...
# Guvnr Tools
guvnr validate       # Validate guvnr setup
guvnr doctor         # Check environment health
guvnr generate       # Regenerate tool configs from guvnr.yaml
```
...
_Generated by Guvnr - Full Preset_
_Edit guvnr.yaml to customize, then run `guvnr generate`_
